<script lang="ts">
  ...
  const variantClasses = {
    ...
    secondary: 'bg-secondary-600 text-white hover:bg-secondary-700 shadow-sm hover:shadow focus:ring-secondary-500',
    danger: 'bg-red-600 text-white hover:bg-red-700 shadow-sm hover:shadow focus:ring-red-500',
